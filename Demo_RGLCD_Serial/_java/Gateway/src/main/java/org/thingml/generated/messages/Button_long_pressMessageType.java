...
public class Button_long_pressMessageType extends EventType {
public Button_long_pressMessageType(short code) {super("button_long_press", code);
}

public Button_long_pressMessageType() {
super("button_long_press", (short) 2);
}

public Event instantiate(final byte but_id) { return new Button_long_pressMessage(this, but_id); }
@Override
...
if (msg.length != 3)
return null;
if ("button_long_press".equals(msg[0])) {
...
public class Button_long_pressMessage extends Event implements java.io.Serializable {

public final byte but_id;
@Override
public String toString(){
return "button_long_press (" + "but_id: " + but_id + ")";
}

protected Button_long_pressMessage(EventType type, final byte but_id) {
super(type);
this.but_id = but_id;
}
@Override
...
if (serialization == null || serialization.equals("default")) {
return toString();
} else if (serialization.equals("json-default")) {return "{\"button_long_press\":{\"but_id\":" + but_id + "}}";
}
//Do NOT remove following comment. Might be used by a serialization plugin
/*STRING_SAVE*/
return null;
